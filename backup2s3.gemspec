Gem::Specification.new do |s|
  ...
  s.has_rdoc = false
  s.files = ["README", "Rakefile", "CHANGELOG", "generators/backup2s3/backup2s3_generator.rb", "generators/backup2s3/templates/backup2s3.rake", "generators/backup2s3/templates/backup2s3.yml", "generators/backup2s3/USAGE", "init.rb", "lib/backup2s3.rb", "lib/backup2s3/system.rb", "lib/backup2s3/adapters/s3_adapter.rb", "lib/backup2s3/backup_management/backup.rb", "lib/backup2s3/backup_management/backup_manager.rb", "Manifest"]
